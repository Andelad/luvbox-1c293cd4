...
"inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:ring-2 focus-visible:ring-offset-2",
  {
    variants: {
      variant: {
      ...
      size: {
        small:"h-10 px-4 py-2 has-[>svg]:px-3", // 40px height
        large:"h-12 px-6 py-3 has-[>svg]:px-5", // 48px height
        default:"h-9 px-4 py-2 has-[>svg]:px-3", // Keep existing default
