import svgPaths from "./svg-ubzgyp1llw";
  ...
  return (
    ...
    >
      <div className="font-['Source_Sans_3:Regular',_sans-serif] font-normal leading-[0] relative shrink-0 text-[#3d3535] text-[20px] text-left text-nowrap">
        <p className="block leading-[24px] whitespace-pre">Cube</p>
      </div>
    </div>
  );
}
  ...
  return (
    ...
    >
      <div className="font-['Source_Sans_3:SemiBold',_sans-serif] font-semibold leading-[0] relative shrink-0 text-[#3d3535] text-[20px] text-left text-nowrap">
        <p className="block leading-[24px] whitespace-pre">Values</p>
      </div>
    </div>
  );
}
...
function PageSection() {
  return <div className="h-[477px] shrink-0 w-full" data-name="Page Section" />;
}
...
function PagePanel() {
  return (
    <div
      className="basis-0 bg-[#ffffff] grow max-w-[1200px] min-h-px min-w-px mr-[-39px] relative rounded-3xl shrink-0"
    ...
    >
      ...
      <div className="absolute border border-[rgba(61,53,53,0.4)] border-solid inset-0 pointer-events-none rounded-3xl shadow-[0px_4px_12px_0px_rgba(0,0,0,0.25)]" />
    </div>
  );
}
